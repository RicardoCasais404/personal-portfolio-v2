    ...
    <div className="flex flex-col">
      ...
      {item.link && (
        <a
          ...
          className="mt-4 inline-block text-sm font-bold text-[#26150f] underline decoration-1 underline-offset-4 hover:opacity-70 active:opacity-70 transition-opacity w-fit"
